Route16Object:
	...
	db $7 ; objects
	object SPRITE_BIKER, $11, $c, STAY, LEFT, $1, TRAINER_START + BIKER, $5
	object SPRITE_BIKER, $e, $d, STAY, RIGHT, $2, TRAINER_START + CUE_BALL, $1
	object SPRITE_BIKER, $b, $c, STAY, UP, $3, TRAINER_START + CUE_BALL, $2
	object SPRITE_BIKER, $9, $b, STAY, LEFT, $4, TRAINER_START + BIKER, $6
	object SPRITE_BIKER, $6, $a, STAY, RIGHT, $5, TRAINER_START + CUE_BALL, $3
	object SPRITE_BIKER, $3, $c, STAY, RIGHT, $6, TRAINER_START + BIKER, $7
