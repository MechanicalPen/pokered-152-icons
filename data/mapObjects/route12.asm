Route12Object:
	...
	object SPRITE_FISHER2, $e, $1f, STAY, LEFT, $2, TRAINER_START + FISHER, $3
	object SPRITE_FISHER2, $5, $27, STAY, UP, $3, TRAINER_START + FISHER, $4
	object SPRITE_BLACK_HAIR_BOY_1, $b, $5c, STAY, LEFT, $4, TRAINER_START + JR__TRAINER_M, $9
	object SPRITE_BLACK_HAIR_BOY_2, $e, $4c, STAY, UP, $5, TRAINER_START + ROCKER, $2
	object SPRITE_FISHER2, $c, $28, STAY, LEFT, $6, TRAINER_START + FISHER, $5
	object SPRITE_FISHER2, $9, $34, STAY, RIGHT, $7, TRAINER_START + FISHER, $6
	object SPRITE_FISHER2, $6, $57, STAY, DOWN, $8, TRAINER_START + FISHER, $b
