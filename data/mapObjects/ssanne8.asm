SSAnne8Object:
	...
	db $b ; objects
	object SPRITE_GENTLEMAN, $2, $3, STAY, LEFT, $1, TRAINER_START + GENTLEMAN, $1
	object SPRITE_GENTLEMAN, $b, $4, STAY, UP, $2, TRAINER_START + GENTLEMAN, $2
	object SPRITE_BUG_CATCHER, $b, $e, STAY, UP, $3, TRAINER_START + YOUNGSTER, $8
	object SPRITE_LASS, $d, $b, STAY, LEFT, $4, TRAINER_START + LASS, $b
