VictoryRoad2Object:
	...
	db $d ; objects
	object SPRITE_HIKER, $c, $9, STAY, LEFT, $1, TRAINER_START + BLACKBELT, $9
	object SPRITE_BLACK_HAIR_BOY_2, $15, $d, STAY, LEFT, $2, TRAINER_START + JUGGLER, $2
	object SPRITE_BLACK_HAIR_BOY_1, $13, $8, STAY, DOWN, $3, TRAINER_START + TAMER, $5
	object SPRITE_BLACK_HAIR_BOY_2, $4, $2, STAY, DOWN, $4, TRAINER_START + POKEMANIAC, $6
	object SPRITE_BLACK_HAIR_BOY_2, $1a, $3, STAY, LEFT, $5, TRAINER_START + JUGGLER, $5
