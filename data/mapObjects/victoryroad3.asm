VictoryRoad3Object:
	...
	db $a ; objects
	object SPRITE_BLACK_HAIR_BOY_1, $1c, $5, STAY, LEFT, $1, TRAINER_START + COOLTRAINER_M, $2
	object SPRITE_LASS, $7, $d, STAY, RIGHT, $2, TRAINER_START + COOLTRAINER_F, $2
	object SPRITE_BLACK_HAIR_BOY_1, $6, $e, STAY, LEFT, $3, TRAINER_START + COOLTRAINER_M, $3
	object SPRITE_LASS, $d, $3, STAY, RIGHT, $4, TRAINER_START + COOLTRAINER_F, $3
