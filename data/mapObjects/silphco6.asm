SilphCo6Object:
	...
	object SPRITE_ROCKET, $11, $3, STAY, RIGHT, $6, TRAINER_START + ROCKET, $1e
	object SPRITE_OAK_AIDE, $7, $8, STAY, DOWN, $7, TRAINER_START + SCIENTIST, $7
	object SPRITE_ROCKET, $e, $f, STAY, LEFT, $8, TRAINER_START + ROCKET, $1f
