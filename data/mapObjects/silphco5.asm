SilphCo5Object:
	...
	object SPRITE_ROCKET, $8, $10, STAY, RIGHT, $2, TRAINER_START + ROCKET, $1c
	object SPRITE_OAK_AIDE, $8, $3, STAY, RIGHT, $3, TRAINER_START + SCIENTIST, $6
	object SPRITE_ROCKER, $12, $a, STAY, UP, $4, TRAINER_START + JUGGLER, $1
	object SPRITE_ROCKET, $1c, $4, STAY, UP, $5, TRAINER_START + ROCKET, $1d
