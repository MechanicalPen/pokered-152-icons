MtMoon1Object:
	...
	db $d ; objects
	object SPRITE_HIKER, $5, $6, STAY, DOWN, $1, TRAINER_START + HIKER, $1
	object SPRITE_BUG_CATCHER, $c, $10, STAY, RIGHT, $2, TRAINER_START + YOUNGSTER, $3
	object SPRITE_LASS, $1e, $4, STAY, DOWN, $3, TRAINER_START + LASS, $5
	object SPRITE_BLACK_HAIR_BOY_2, $18, $1f, STAY, UP, $4, TRAINER_START + SUPER_NERD, $1
	object SPRITE_LASS, $10, $17, STAY, DOWN, $5, TRAINER_START + LASS, $6
	object SPRITE_BUG_CATCHER, $7, $16, STAY, DOWN, $6, TRAINER_START + BUG_CATCHER, $7
	object SPRITE_BUG_CATCHER, $1e, $1b, STAY, RIGHT, $7, TRAINER_START + BUG_CATCHER, $8
