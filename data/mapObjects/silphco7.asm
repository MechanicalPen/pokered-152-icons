SilphCo7Object:
	...
	object SPRITE_ROCKET, $d, $1, STAY, DOWN, $5, TRAINER_START + ROCKET, $20
	object SPRITE_OAK_AIDE, $2, $d, STAY, DOWN, $6, TRAINER_START + SCIENTIST, $8
	object SPRITE_ROCKET, $14, $2, STAY, LEFT, $7, TRAINER_START + ROCKET, $21
	object SPRITE_ROCKET, $13, $e, STAY, RIGHT, $8, TRAINER_START + ROCKET, $22
