...
_ViridianForestBattleTextCatCollector::
	text "Say! Wanna see my"
	line "collection?"
	done

_ViridianForestEndBattleTextCatCollector::
	text "It's"
	line "just for show..."
	prompt

_ViridianForestAfterBattleTextCatCollector::
	text "I need BUTTERFREE"
	line "to complete my"
	cont "collection. Seen"
	cont "any around?"
	done
...
_ViridianForestAfterBattleTextPikaGirl::
	...
	line "but I did find a"
	cont "PIKACHU in here."
	done
