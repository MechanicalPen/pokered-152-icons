RocketHideout4Object:
	...
	db $9 ; objects
	object SPRITE_GIOVANNI, $19, $3, STAY, DOWN, $1, TRAINER_START + GIOVANNI, $1
	object SPRITE_ROCKET, $17, $c, STAY, DOWN, $2, TRAINER_START + ROCKET, $10
	object SPRITE_ROCKET, $1a, $c, STAY, DOWN, $3, TRAINER_START + ROCKET, $11
	object SPRITE_ROCKET, $b, $2, STAY, DOWN, $4, TRAINER_START + ROCKET, $12
