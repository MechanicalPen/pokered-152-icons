SilphCo11Object:
	...
	object SPRITE_GIOVANNI, $6, $9, STAY, DOWN, $3, TRAINER_START + GIOVANNI, $2
	object SPRITE_ROCKET, $3, $10, STAY, UP, $4, TRAINER_START + ROCKET, $29
	object SPRITE_ROCKET, $f, $9, STAY, UP, $5, TRAINER_START + ROCKET, $28
