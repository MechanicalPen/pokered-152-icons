...
;_MisdreavusDexEntry::
;	text "They live off fear"
;	next "and will startle"
;	next "people by biting"
...
_MisdreavusDexEntry::
	text "It loves startling"
	next "people by shriek-"
	next "ing unexpectedly"

	page "or biting their"
	next "hair. It uses fear"
	next "as a food source"
	dex

;_MisdreavusDexEntry::
;	text "It loves to eat"
;	next "fear. It startles"
;	next "people by shriek-"

;	page "ing unexpectedly"
;	next "and pulling their"
;	next "hair"
;	dex
