...
; preserves de unless you ask for losetext, a = $a
...
.nonZeroOffset
	...
	cp $a
	jr nz, .done
	pop de ;we are overwriting de here, so throw away old value.
...
.trainerNotYetFought ; 0x31ed
	...
	call PrintText
	ld a, $a
	;TODO: fiddle with all this stuff to get lose texts working.
