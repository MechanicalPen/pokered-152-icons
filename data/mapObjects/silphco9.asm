SilphCo9Object:
	...
	object SPRITE_ROCKET, $2, $4, STAY, UP, $2, TRAINER_START + ROCKET, $25
	object SPRITE_OAK_AIDE, $15, $d, STAY, DOWN, $3, TRAINER_START + SCIENTIST, $a
	object SPRITE_ROCKET, $d, $10, STAY, UP, $4, TRAINER_START + ROCKET, $26
