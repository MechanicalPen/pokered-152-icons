SSAnne10Object:
	...
	db $b ; objects
	object SPRITE_SAILOR, $0, $d, STAY, DOWN, $1, TRAINER_START + SAILOR, $3
	object SPRITE_SAILOR, $2, $b, STAY, DOWN, $2, TRAINER_START + SAILOR, $4
	object SPRITE_SAILOR, $c, $3, STAY, LEFT, $3, TRAINER_START + SAILOR, $5
	object SPRITE_SAILOR, $16, $2, STAY, DOWN, $4, TRAINER_START + SAILOR, $6
	object SPRITE_SAILOR, $0, $2, STAY, RIGHT, $5, TRAINER_START + SAILOR, $7
	object SPRITE_FISHER2, $0, $4, STAY, RIGHT, $6, TRAINER_START + FISHER, $2
