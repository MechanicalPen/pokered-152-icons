...
endm
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, FIGHTING, 100, 25 ;* Fighting move duh!
	...
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 35 ;* Pound and this are the same.
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, NORMAL,   100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,    40,  5
	move RAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL,   100, 10 ;*more accurate, hicrit.
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,   100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,    95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        40, FLYING,   100, 35 ;* flying move duh!
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        60, FLYING,   100, 35 ;* wing attack BP changed
	...
	move THRASH,       RAMPAGE_EFFECT,              90, NORMAL,   100, 20
	move DOUBLE_EDGE,  RECOIL_EFFECT,              100, NORMAL,   100, 15
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, NORMAL,   100, 30
	move POISON_STING, POISON_SIDE_EFFECT1,         25, POISON,   100, 35 ; *BP to 25, whatever.
	move TWINEEDLE,    TWINEEDLE_EFFECT,            25, BUG,      100, 20
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, BUG,       95, 20 ;*like gen 6.
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, NORMAL,   100, 30
	move BITE,         FLINCH_SIDE_EFFECT2,         60, NORMAL,   100, 25 ; *Flinch chance up!
	...
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,   100, 20 ; *accuracy up!
	...
	move BLIZZARD,     FREEZE_SIDE_EFFECT,         120, ICE,       80,  5 ; *Accuracy down
	...
	move ABSORB,       DRAIN_HP_EFFECT,             20, GRASS,    100, 25 ;*pp up
	...
	move PETAL_DANCE,  RAMPAGE_EFFECT,              70, GRASS,    100, 20
	move STRING_SHOT,  SPEED_DOWN2_EFFECT,           0, BUG,       95, 40
	move DRAGON_RAGE,  SPECIAL_DAMAGE_EFFECT,        1, DRAGON,   100, 10
	move FIRE_SPIN,    TRAPPING_EFFECT,             18, FIRE,      85, 15
	move THUNDERSHOCK, PARALYZE_SIDE_EFFECT1,       40, ELECTRIC, 100, 30
	move THUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       95, ELECTRIC, 100, 15
	move THUNDER_WAVE, PARALYZE_EFFECT,              0, ELECTRIC,  90, 20 ;*if you say so gen 7
	move THUNDER,      PARALYZE_SIDE_EFFECT1,      120, ELECTRIC,  70, 10
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, ROCK,      90, 15 ;*Accuracy improved.
	...
	move RAGE,         RAGE_EFFECT,                 20, NORMAL,   100, 20 ;*Rage dosen't lock in!
	...
	move CLAMP,        TRAPPING_EFFECT,             35, WATER,     80, 10
	move SWIFT,        SWIFT_EFFECT,                60, NORMAL,   100, 20
	move SKULL_BASH,   CHARGE_EFFECT,              100, NORMAL,   100, 15 ;added defense up effect.
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,   100, 15
	move CONSTRICT,    SPEED_DOWN_SIDE_EFFECT,      35, NORMAL,   100, 30 ; BP to 35, whatever.
	...
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,    95, 30 ;more accurate.
	move DREAM_EATER,  DREAM_EATER_EFFECT,         100, PSYCHIC,  100, 15
	move POISON_GAS,   POISON_EFFECT,                0, POISON,    95, 40 ;more accurate.
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,    85, 20
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             80, BUG,      100, 10 ;*like gen 7.
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,    75, 10
	move SKY_ATTACK,   CHARGE_EFFECT,              140, FLYING,    90,  5 ;* 30% flinch chance
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,   100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      30, WATER,    100, 30 ; BP to 30, whatever.
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, NORMAL,   100, 10 ;*Added confusion chance!
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,    100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,   100, 20
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC,   95, 15
	move SPLASH,       SPLASH_EFFECT,                0, NORMAL,   100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,   100, 40
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        90, WATER,     90, 10;*like gen 5.
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT2,         75, ROCK,      90, 10 ;*yeh flinching.
	...
	move OUTRAGE,      RAMPAGE_EFFECT,              90, DRAGON,   100, 15
	move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT,    80, GHOST,    100, 15
	move X_SCISSOR,    NO_ADDITIONAL_EFFECT,        80, BUG,      100, 15 ;not in gen 2.
	move CROSS_CHOP,   NO_ADDITIONAL_EFFECT,       100, FIGHTING,  80,  5
	move ROCK_BLAST,   TWO_TO_FIVE_ATTACKS_EFFECT,  25, ROCK,      90, 10 ;not in gen 2.
	move SLUDGE_BOMB,  POISON_SIDE_EFFECT2,         90, POISON,   100, 10
	;add extreme speed?
	;FC, FD, FE are available as moves in pokecrystal. we can add one more move.
