Route18Object:
	...
	db $3 ; objects
	object SPRITE_BLACK_HAIR_BOY_1, $24, $b, STAY, RIGHT, $1, TRAINER_START + BIRD_KEEPER, $8
	object SPRITE_BLACK_HAIR_BOY_1, $28, $f, STAY, LEFT, $2, TRAINER_START + BIRD_KEEPER, $9
	object SPRITE_BLACK_HAIR_BOY_1, $2a, $d, STAY, LEFT, $3, TRAINER_START + BIRD_KEEPER, $a
