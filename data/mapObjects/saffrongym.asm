SaffronGymObject:
	...
	db $9 ; objects
	object SPRITE_GIRL, $9, $8, STAY, DOWN, $1, TRAINER_START + SABRINA, $1
	object SPRITE_MEDIUM, $a, $1, STAY, DOWN, $2, TRAINER_START + CHANNELER, $16
	object SPRITE_BUG_CATCHER, $11, $1, STAY, DOWN, $3, TRAINER_START + PSYCHIC_TR, $1
	object SPRITE_MEDIUM, $3, $7, STAY, DOWN, $4, TRAINER_START + CHANNELER, $17
	object SPRITE_BUG_CATCHER, $11, $7, STAY, DOWN, $5, TRAINER_START + PSYCHIC_TR, $2
	object SPRITE_MEDIUM, $3, $d, STAY, DOWN, $6, TRAINER_START + CHANNELER, $18
	object SPRITE_BUG_CATCHER, $11, $d, STAY, DOWN, $7, TRAINER_START + PSYCHIC_TR, $3
	object SPRITE_BUG_CATCHER, $3, $1, STAY, DOWN, $8, TRAINER_START + PSYCHIC_TR, $4
