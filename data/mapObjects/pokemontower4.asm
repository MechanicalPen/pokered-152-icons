PokemonTower4Object:
	...
	db $6 ; objects
	object SPRITE_MEDIUM, $5, $a, STAY, RIGHT, $1, TRAINER_START + CHANNELER, $9
	object SPRITE_MEDIUM, $f, $7, STAY, DOWN, $2, TRAINER_START + CHANNELER, $a
	object SPRITE_MEDIUM, $e, $c, STAY, LEFT, $3, TRAINER_START + CHANNELER, $c
