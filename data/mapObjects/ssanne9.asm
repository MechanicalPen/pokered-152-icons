SSAnne9Object:
	...
	db $d ; objects
	object SPRITE_GENTLEMAN, $a, $2, STAY, RIGHT, $1, TRAINER_START + GENTLEMAN, $3
	object SPRITE_FISHER2, $d, $4, STAY, LEFT, $2, TRAINER_START + FISHER, $1
	object SPRITE_GENTLEMAN, $0, $e, STAY, RIGHT, $3, TRAINER_START + GENTLEMAN, $5
	object SPRITE_LASS, $2, $b, STAY, DOWN, $4, TRAINER_START + LASS, $c
