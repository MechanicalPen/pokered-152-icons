PokemonTower3Object:
	...
	db $4 ; objects
	object SPRITE_MEDIUM, $c, $3, STAY, LEFT, $1, TRAINER_START + CHANNELER, $5
	object SPRITE_MEDIUM, $9, $8, STAY, DOWN, $2, TRAINER_START + CHANNELER, $6
	object SPRITE_MEDIUM, $a, $d, STAY, DOWN, $3, TRAINER_START + CHANNELER, $8
