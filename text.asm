...
;;TEXT MUST BE 18 CHARACTERS A LINE OR LESS.
;;Player name / rival name is 7.
;; trainer names can be up to 13 letters. plus 2 for ": "
;; 17 characters for conts.
...
_CableClubNPCLinkClosedBecauseOfIncompatibleGame:: ; a29db (28:69db)
	text "The linked version"
	line "of #MON is not"
	cont "compatible."

	para "Your friend may"
	line "copy a save file"
	cont "into C.N.W. and"
	cont "come again!"
	done
