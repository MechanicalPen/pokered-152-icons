SilphCo2Object:
	...
	object SPRITE_OAK_AIDE, $5, $c, STAY, DOWN, $2, TRAINER_START + SCIENTIST, $2
	object SPRITE_OAK_AIDE, $18, $d, STAY, LEFT, $3, TRAINER_START + SCIENTIST, $3
	object SPRITE_ROCKET, $10, $b, STAY, UP, $4, TRAINER_START + ROCKET, $17
	object SPRITE_ROCKET, $18, $7, STAY, UP, $5, TRAINER_START + ROCKET, $18
