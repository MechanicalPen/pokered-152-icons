SilphCo8Object:
	...
	object SPRITE_ROCKET, $13, $2, STAY, LEFT, $2, TRAINER_START + ROCKET, $23
	object SPRITE_OAK_AIDE, $a, $2, STAY, DOWN, $3, TRAINER_START + SCIENTIST, $9
	object SPRITE_ROCKET, $c, $f, STAY, RIGHT, $4, TRAINER_START + ROCKET, $24
