ViridianForestObject:
	...
	object SPRITE_BUG_CATCHER, $1e, $21, STAY, LEFT, $2, TRAINER_START + BUG_CATCHER, $1
	object SPRITE_BUG_CATCHER, $1e, $13, STAY, LEFT, $3, TRAINER_START + BUG_CATCHER, $2
	object SPRITE_BUG_CATCHER, $2, $12, STAY, LEFT, $4, TRAINER_START + BUG_CATCHER, $3
	object SPRITE_BUG_CATCHER, 16, 2, STAY, DOWN, $5, TRAINER_START + BUG_CATCHER, 15
	object SPRITE_LASS, 6, 34, STAY, UP, $6, TRAINER_START + LASS, 19 ;todo add pikachu lass.
	object SPRITE_BALL, $19, $b, STAY, NONE, $7, ANTIDOTE
	object SPRITE_BALL, $c, $1d, STAY, NONE, $8, POTION
	object SPRITE_BALL, $1, $1f, STAY, NONE, $9, POTION
