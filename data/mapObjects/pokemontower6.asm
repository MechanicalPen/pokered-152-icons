PokemonTower6Object:
	...
	db $5 ; objects
	object SPRITE_MEDIUM, $c, $a, STAY, RIGHT, $1, TRAINER_START + CHANNELER, $13
	object SPRITE_MEDIUM, $9, $5, STAY, DOWN, $2, TRAINER_START + CHANNELER, $14
	object SPRITE_MEDIUM, $10, $5, STAY, LEFT, $3, TRAINER_START + CHANNELER, $15
