...
OakSpeech: ; 6115 (1:6115)
	...
	call GBFadeOutToWhite
	call ClearScreen
	call FadeInIntroPic ;make things not white.
	;boy / girl selection.
    ...
    and a
    ld hl, wPlayerID + 1 ; girls have odd player ID's boys have even.
	jr z, .boySelected ; skip setting the girl and leave that flag alone if you chose the boy
    set 0, [hl]      ; sets you as a girl
	jr .genderDone
.boySelected
	res 0, [hl]
.genderDone:
	...
	jr z, .playerFrontPicSelected
	ld de,GreenPicFront
	ld bc,(Bank(GreenPicFront) << 8) | $00
.playerFrontPicSelected
