...
.asm_510a8
	...
	ld de, Route22RivalWinText2 ; $51d0
	call SaveEndBattleTextPointers
	ld a, SONY2 + $c8
...
Route22RivalWinText1: ; 511bc (14:51bc)
	TX_FAR _Route22RivalWinText1
	db "@"
...
Route22RivalWinText2: ; 511d0 (14:51d0)
	TX_FAR _Route22RivalWinText2
	db "@"
