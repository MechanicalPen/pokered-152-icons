MtMoon3Object:
	...
	db $9 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, $c, $8, STAY, RIGHT, $1, TRAINER_START + SUPER_NERD, $2
	object SPRITE_ROCKET, $b, $10, STAY, DOWN, $2, TRAINER_START + ROCKET, $1
	object SPRITE_ROCKET, $f, $16, STAY, DOWN, $3, TRAINER_START + ROCKET, $2
	object SPRITE_ROCKET, $1d, $b, STAY, UP, $4, TRAINER_START + ROCKET, $3
	object SPRITE_ROCKET, $1d, $11, STAY, LEFT, $5, TRAINER_START + ROCKET, $4
